...
- **Error messages** (`source/library/src/kmx/aio/knx/detail/category.cpp`) are fixed strings. No message is formatted
  with frame contents, keys, passwords or addresses.
