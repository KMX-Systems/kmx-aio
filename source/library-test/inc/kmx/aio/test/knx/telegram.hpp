/// @file kmx/aio/test/knx/telegram.hpp
...
namespace kmx::aio::test::knx
{
    ...
    inline constexpr std::array<std::uint8_t, sample_cemi_size> sample_cemi = kmx::aio::knx::detail::vectors::group_value_write_on;
    ...
    inline constexpr std::array<std::uint8_t, sample_cemi_size> sample_cemi_read = kmx::aio::knx::detail::vectors::group_value_read;

    /// @brief An A_GroupValue_Write telegram carrying 21.5 degrees as a 2-octet KNX float.
    inline constexpr std::array<std::uint8_t, 13u> sample_cemi_temperature = kmx::aio::knx::detail::vectors::group_value_write_temperature;
