/// @file src/kmx/aio/allocator/slab_coroutine_test.cpp
...
namespace kmx::aio::test::allocator::slab_coroutine_test::detail
{
...
namespace kmx::aio::test::allocator::slab_coroutine_test
{
    TEST_CASE("coroutine frames allocate from thread-local slab", "[allocation][slab][coroutine]")
    {
        ...
        auto& stats = kmx::aio::allocator::get_statistics();
        ...
        kmx::aio::allocator::set_thread_slab(alloc.get());
        ...
        kmx::aio::allocator::set_thread_slab(nullptr);
    }
    ...
    TEST_CASE("thread-local allocator isolation", "[allocation][slab][thread-local]")
    {
        ...
        kmx::aio::allocator::set_thread_slab(alloc1.get());
        REQUIRE(kmx::aio::allocator::get_thread_slab() == alloc1.get());
        ...
        // Clear thread-local.
        kmx::aio::allocator::set_thread_slab(nullptr);
        REQUIRE(kmx::aio::allocator::get_thread_slab() == nullptr);
    ...
    TEST_CASE("a coroutine frame freed on another thread returns to its slab", "[allocation][slab][coroutine][thread-local]")
    {
        ...
        kmx::aio::allocator::set_thread_slab(&slab);
