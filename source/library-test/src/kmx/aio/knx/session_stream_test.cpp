/// @file kmx/aio/knx/session_stream_test.cpp
...
namespace kmx::aio::test::knx::session_stream_test
{
    ...
    namespace detail
    {
        ...
        [[nodiscard]] tunnelling_session connected_stream_session(const tunnelling_config& config = {})
        {
    ...
    {
        auto session = detail::connected_stream_session();
        std::array<std::uint8_t, sample_tunnelling_packet_size> packet {};
    ...
    {
        auto session = detail::connected_stream_session({.heartbeat_failure_limit = 2u});
