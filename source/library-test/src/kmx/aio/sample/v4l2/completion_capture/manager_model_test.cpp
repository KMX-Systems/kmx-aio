/// @file src/kmx/aio/sample/v4l2/completion_capture/manager_model_test.cpp
...
namespace kmx::aio::test::sample::v4l2::completion_capture::manager_model_test
{
    using kmx::aio::sample::v4l2::completion_capture::frame_result;
    using kmx::aio::sample::v4l2::completion_capture::simulate_manager;
    using kmx::aio::sample::v4l2::completion_capture::startup_error;
    using kmx::aio::sample::v4l2::completion_capture::step_results;
    ...
    {
        const std::array<frame_result, 3u> frames {
            frame_result {.recv_ok = true, .frame_ok = true, .bytes_used = 1024u},
            frame_result {.recv_ok = true, .frame_ok = false, .bytes_used = 2048u},
            frame_result {.recv_ok = false, .frame_ok = true, .bytes_used = 4096u},
        };
