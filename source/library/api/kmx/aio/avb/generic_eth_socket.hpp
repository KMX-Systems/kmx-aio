/// @file api/kmx/aio/avb/generic_eth_socket.hpp
...
namespace kmx::aio::avb
{
    ...
    public:
        ...
        [[nodiscard]] task<std::expected<std::pair<std::vector<std::byte>, tai_timestamp_t>, std::error_code>> recv() noexcept(false);
