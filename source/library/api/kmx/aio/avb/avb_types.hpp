...
namespace kmx::aio::avb
{
    ...
    struct vlan_tag_t
    {
        ...
        std::uint8_t dei {};          ///< Drop Eligible Indicator
    ...
    namespace ethertype
    {
        inline constexpr std::uint16_t avtp = 0x22F0u; ///< IEEE 1722 AVTP
        inline constexpr std::uint16_t gptp = 0x88F7u; ///< IEEE 802.1AS gPTP
        inline constexpr std::uint16_t msrp = 0x22EAu; ///< IEEE 802.1Qat SRP
        inline constexpr std::uint16_t vlan = 0x8100u; ///< IEEE 802.1Q VLAN
    }
