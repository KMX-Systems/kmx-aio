...
namespace kmx::aio::knx
{
    ...
    namespace connection
    {
        ...
        [[nodiscard]] std::expected<void, std::error_code> encode_connect_request_packet(
            span_uint8_t dest, const connect_request_frame& request) noexcept;
        [[nodiscard]] std::expected<connect_request_frame, std::error_code> decode_connect_request_packet(
            cspan_uint8_t packet) noexcept;
        [[nodiscard]] std::expected<void, std::error_code> encode_ipv6_connect_request_packet(
        ...
        [[nodiscard]] std::expected<ipv6_connect_request_frame, std::error_code> decode_ipv6_connect_request_packet(
            cspan_uint8_t packet) noexcept;
        [[nodiscard]] std::expected<void, std::error_code> encode_connect_response_packet(
            span_uint8_t dest, const connect_response_frame& response) noexcept;
        [[nodiscard]] std::expected<connect_response_frame, std::error_code> decode_connect_response_packet(
            cspan_uint8_t packet) noexcept;
        [[nodiscard]] std::expected<void, std::error_code> encode_ipv6_connect_response_packet(
        ...
        [[nodiscard]] std::expected<ipv6_connect_response_frame, std::error_code> decode_ipv6_connect_response_packet(
            cspan_uint8_t packet) noexcept;
        [[nodiscard]] std::expected<void, std::error_code> encode_connectionstate_request_packet(
        ...
        [[nodiscard]] std::expected<connectionstate_request_frame, std::error_code> decode_connectionstate_request_packet(
            cspan_uint8_t packet) noexcept;
        [[nodiscard]] std::expected<void, std::error_code> encode_connectionstate_response_packet(
        ...
        [[nodiscard]] std::expected<connectionstate_response_frame, std::error_code> decode_connectionstate_response_packet(
            cspan_uint8_t packet) noexcept;
        [[nodiscard]] std::expected<void, std::error_code> encode_disconnect_request_packet(
        ...
        [[nodiscard]] std::expected<disconnect_request_frame, std::error_code> decode_disconnect_request_packet(
            cspan_uint8_t packet) noexcept;
        [[nodiscard]] std::expected<void, std::error_code> encode_disconnect_response_packet(
