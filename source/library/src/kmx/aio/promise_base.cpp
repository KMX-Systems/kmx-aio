/// @file src/kmx/aio/promise_base.cpp
/// @brief Coroutine frame operator new/delete for task promises: thread-local slab allocation with a heap fallback.
/// @copyright Copyright (C) 2026 - present KMX Systems. All rights reserved.
/// @details std::coroutine_traits allocator requirement.
///
...
///   - allocator::set_thread_slab(ptr) should be called at executor startup (per core).
///   - allocator::get_thread_slab() retrieves the active slab for the current thread.
