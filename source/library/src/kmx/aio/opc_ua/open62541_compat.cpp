...
extern "C"
{
    ...
    UA_StatusCode KMX_UA_Client_sendAsyncReadRequest(UA_Client* client, const char* nodeId, const UA_UInt32 requestId,
    ...
    UA_StatusCode KMX_UA_Client_sendAsyncWriteRequest(UA_Client* client, const char* nodeId, const char* value, const UA_UInt32 requestId,
    ...
    UA_StatusCode KMX_UA_Client_sendAsyncCallRequest(UA_Client* client, const char* objectNodeId, const char* methodNodeId,
                                                     const char* const* inputArguments, const UA_UInt32 inputArgumentsSize,
                                                     const UA_UInt32 requestId, KMX_UA_CallRequestCallback callback, void* userData)
    {
...
namespace
{
    ...
    void on_read_value_attribute(UA_Client* /*client*/, void* userdata, const UA_UInt32 /*internal_request_id*/, const UA_StatusCode status,
                                 UA_DataValue* value)
    {
    ...
    void on_write_response(UA_Client* /*client*/, void* userdata, const UA_UInt32 /*internal_request_id*/, UA_WriteResponse* response)
    {
    ...
    void on_call_response(UA_Client* /*client*/, void* userdata, const UA_UInt32 /*internal_request_id*/, UA_CallResponse* response)
    {
...
extern "C"
{
                                                     ...
                                                     const UA_UInt32 requestId, KMX_UA_CallRequestCallback callback, void* userData)
    {
        ...
        for (UA_UInt32 i = 0; i < inputArgumentsSize; ++i)
        {
            ...
            const UA_StatusCode variant_status = UA_Variant_setScalarCopy(&input_variants[i], &ua_text, &UA_TYPES[UA_TYPES_STRING]);
            if (variant_status != UA_STATUSCODE_GOOD)
            {
        ...
        UA_UInt32 upstream_request_id = 0u;
        const UA_StatusCode submit_status = UA_Client_call_async(
            client, object_node_id, method_node_id, static_cast<size_t>(input_variants.size()),
            input_variants.empty() ? nullptr : input_variants.data(), &on_call_response, context.get(), &upstream_request_id);
