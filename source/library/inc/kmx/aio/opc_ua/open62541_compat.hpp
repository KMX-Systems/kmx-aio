...
using KMX_UA_ReadRequestCallback = void (*)(void* userData,
                                            UA_UInt32 requestId,
...
/// @param requestId Wrapper-level request identifier.
/// @param status OPC UA status code.
using KMX_UA_WriteRequestCallback = void (*)(void* userData,
                                             UA_UInt32 requestId,
                                             UA_StatusCode status);
...
using KMX_UA_CallRequestCallback = void (*)(void* userData,
                                            UA_UInt32 requestId,
                                            UA_StatusCode status,
                                            const char* const* outputArguments,
