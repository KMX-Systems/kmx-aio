/// @file src/main.cpp
/// @brief Entry point of the completion-model AVB listener sample: parses options and runs the manager.
...
namespace kmx::aio::sample::avb::listener::detail
{
    ...
    [[nodiscard]] static parse_status parse_talker_mac_option(const std::string_view value, kmx::aio::sample::avb::listener::config& cfg)
    {
    ...
    [[nodiscard]] static parse_status parse_stream_id_option(const std::string_view value, kmx::aio::sample::avb::listener::config& cfg)
    {
        std::uint16_t parsed {};
    ...
    [[nodiscard]] static parse_status parse_max_frames_option(const std::string_view value, kmx::aio::sample::avb::listener::config& cfg)
    {
        std::uint64_t parsed {};
    ...
    [[nodiscard]] static parse_status parse_period_us_option(const std::string_view value, kmx::aio::sample::avb::listener::config& cfg,
    ...
    [[nodiscard]] static parse_status parse_sync_timeout_s_option(const std::string_view value,
    ...
    [[nodiscard]] static parse_status parse_args(int argc, const char* argv[], kmx::aio::sample::avb::listener::config& cfg)
    {
