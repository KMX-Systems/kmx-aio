/// @file main.cpp
/// @brief Phase 5 Control-Plane Validation: HFT Order Router.
/// @details Demonstrates two CPU-pinned io_uring executor threads communicating
///          exclusively via a lockless kmx::aio::channel<order>. The market-data
///          thread (Core 2) generates synthetic ticks and pushes orders into the
///          channel. The strategy thread (Core 4) consumes them and applies a
///          trivial fill/reject logic, proving zero-contention cross-thread dispatch.
