...
namespace kmx::aio::sample::tcp::echo::client
{
    ...
    private:
        ...
        [[nodiscard]] task<std::expected<kmx::aio::tcp::stream, std::error_code>> async_connect() noexcept;
        ...
        [[nodiscard]] task<void> worker_sender(std::shared_ptr<kmx::aio::tcp::stream> stream, const std::uint32_t worker_id,
