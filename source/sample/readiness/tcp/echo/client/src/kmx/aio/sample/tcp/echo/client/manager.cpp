...
namespace kmx::aio::sample::tcp::echo::client
{
    ...
    task<std::expected<kmx::aio::readiness::tcp::stream, std::error_code>> manager::async_connect() noexcept
    {
        ...
        co_return kmx::aio::readiness::tcp::stream(*executor_, std::move(fd_owner));
    }
    ...
    kmx::aio::task<void> manager::worker_sender(std::shared_ptr<kmx::aio::readiness::tcp::stream> stream, const std::uint32_t worker_id,
