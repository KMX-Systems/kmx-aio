/// @file src/main.cpp
/// @brief Entry point of the readiness-model minimal UDP client sample: runs the manager with default settings.
...
int main() noexcept
{
    try
    {
        kmx::aio::sample::udp::minimal::client::manager client;
